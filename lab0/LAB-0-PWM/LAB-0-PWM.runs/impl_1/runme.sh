...
HD_PWD='C:/Users/euzun/Desktop/DESD/LAB-0-PWM/LAB-0-PWM.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log PulseWidthModulator.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source PulseWidthModulator.tcl -notrace
