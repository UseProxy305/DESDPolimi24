...
HD_PWD='C:/Users/euzun/Desktop/DESD/LAB-0-PWM/LAB-0-PWM.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log PulseWidthModulator.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source PulseWidthModulator.tcl
