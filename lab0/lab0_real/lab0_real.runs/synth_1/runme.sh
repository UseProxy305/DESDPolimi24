...
HD_PWD='C:/Users/euzun/Desktop/DESD/lab0_real/lab0_real.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ShiftRegister_v2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ShiftRegister_v2.tcl
