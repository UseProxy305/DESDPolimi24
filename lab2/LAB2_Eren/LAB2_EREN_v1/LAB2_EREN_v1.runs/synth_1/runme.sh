...
HD_PWD='C:/Users/euzun/Desktop/DESD/LAB2_Eren/LAB2_EREN_v1/LAB2_EREN_v1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log digilent_jstk2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source digilent_jstk2.tcl
