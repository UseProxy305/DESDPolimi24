...
--               c:/Users/euzun/Desktop/DESD/LAB2_Eren/LAB2_Clean_Eren_v1/LAB2_Clean_Eren_v1.gen/sources_1/bd/Project_1/ip/Project_1_digilent_jstk2_0_0/Project_1_digilent_jstk2_0_0_sim_netlist.vhdl
...
architecture STRUCTURE of Project_1_digilent_jstk2_0_0_digilent_jstk2 is
  ...
  attribute SOFT_HLUTNM of btn_jstk_i_4 : label is "soft_lutpair1";
  ...
  attribute SOFT_HLUTNM of \delay_count[0]_i_1\ : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of \delay_count[31]_i_7\ : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of \dummy[1]_i_2\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \m_axis_tdata[6]_i_2\ : label is "soft_lutpair2";
...
\delay_count[31]_i_1\: unisim.vcomponents.LUT6
    generic map(
      ...
      I1 => \delay_count[31]_i_3_n_0\,
      I2 => \delay_count[31]_i_4_n_0\,
      I3 => \delay_count[31]_i_5_n_0\,
      I4 => \delay_count[31]_i_6_n_0\,
      I5 => \delay_count[31]_i_7_n_0\,
...
\delay_count[31]_i_4\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFEF"
    )
        port map (
...
\delay_count[31]_i_5\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"0001"
    )
        port map (
...
\delay_count[31]_i_7\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"7"
    )
        port map (
...
\m_axis_tdata[6]_i_4\: unisim.vcomponents.LUT6
    generic map(
      ...
      I3 => delay_count(13),
      I4 => delay_count(4),
      I5 => \delay_count[31]_i_4_n_0\,
      O => \m_axis_tdata[6]_i_4_n_0\
    );
\m_axis_tdata[6]_i_5\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"5FD7"
    )
        port map (
...
m_axis_tvalid_i_6: unisim.vcomponents.LUT6
    generic map(
      ...
      I2 => delay_count(10),
      I3 => delay_count(13),
      I4 => \delay_count[31]_i_4_n_0\,
      I5 => m_axis_tvalid_i_9_n_0,
      O => m_axis_tvalid_i_6_n_0
    );
m_axis_tvalid_i_7: unisim.vcomponents.LUT6
    generic map(
      INIT => X"BEFFFFFFFFFDFFBF"
    )
        port map (
      I0 => delay_count(4),
      I1 => delay_count(1),
...
architecture STRUCTURE of Project_1_digilent_jstk2_0_0 is
  ...
  signal \^m_axis_tdata\ : STD_LOGIC_VECTOR ( 5 to 5 );
