...
proc create_root_design { parentCell } {
  ...
  connect_bd_net -net Net [get_bd_ports sys_clock] [get_bd_pins axi4stream_spi_master_0/aclk] [get_bd_pins digilent_jstk2_0/aclk] [get_bd_pins proc_sys_reset_0/slowest_sync_clk]
  ...
  connect_bd_net -net rst_clk_wiz_100M_peripheral_aresetn [get_bd_pins axi4stream_spi_master_0/aresetn] [get_bd_pins digilent_jstk2_0/aresetn] [get_bd_pins proc_sys_reset_0/peripheral_aresetn]
