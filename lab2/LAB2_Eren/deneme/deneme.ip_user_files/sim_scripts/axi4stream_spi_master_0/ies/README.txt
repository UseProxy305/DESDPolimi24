...
#
# Generated by export_simulation on Sat Apr 20 14:53:47 +0200 2024
#
################################################################################
...
'-reset_run' switch to the './axi4stream_spi_master_0.sh' script.

./axi4stream_spi_master_0.sh -reset_run
...
./axi4stream_spi_master_0.sh -noclean_files

For more information on the script, please type './axi4stream_spi_master_0.sh -help'.
