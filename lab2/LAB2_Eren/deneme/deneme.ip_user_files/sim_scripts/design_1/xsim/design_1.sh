...
elaborate()
{
  xelab --relax --debug typical --mt auto -L xil_defaultlib -L lib_cdc_v1_0_2 -L proc_sys_reset_v5_0_13 -L secureip -L xpm --snapshot design_1 xil_defaultlib.design_1 -log elaborate.log
}
