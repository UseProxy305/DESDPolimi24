...
proc create_root_design { parentCell } {
  ...
  connect_bd_net -net Net [get_bd_pins AXI4Stream_UART_0/m00_axis_rx_aresetn] [get_bd_pins AXI4Stream_UART_0/s00_axis_tx_aresetn] [get_bd_pins axi4stream_spi_master_0/aresetn] [get_bd_pins digilent_jstk2_0/aresetn] [get_bd_pins jstk_uart_bridge_0/aresetn] [get_bd_pins rst_clk_wiz_0_100M/peripheral_aresetn]
  ...
  connect_bd_net -net digilent_jstk2_0_eren_debug_spi [get_bd_pins digilent_jstk2_0/eren_debug_spi] [get_bd_pins jstk_uart_bridge_0/eren_debug]
  connect_bd_net -net reset_1 [get_bd_ports reset] [get_bd_pins clk_wiz_0/reset] [get_bd_pins rst_clk_wiz_0_100M/ext_reset_in]
  connect_bd_net -net rst_clk_wiz_0_100M_peripheral_reset [get_bd_pins AXI4Stream_UART_0/rst] [get_bd_pins rst_clk_wiz_0_100M/peripheral_reset]
  connect_bd_net -net sys_clock_1 [get_bd_pins AXI4Stream_UART_0/clk_uart] [get_bd_pins AXI4Stream_UART_0/m00_axis_rx_aclk] [get_bd_pins AXI4Stream_UART_0/s00_axis_tx_aclk] [get_bd_pins axi4stream_spi_master_0/aclk] [get_bd_pins clk_wiz_0/clk_out1] [get_bd_pins digilent_jstk2_0/aclk] [get_bd_pins jstk_uart_bridge_0/aclk] [get_bd_pins rst_clk_wiz_0_100M/slowest_sync_clk]
