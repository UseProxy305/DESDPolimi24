...
elaborate()
{
  xelab --relax --debug typical --mt auto -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot Project_1 xil_defaultlib.Project_1 xil_defaultlib.glbl -log elaborate.log
}
